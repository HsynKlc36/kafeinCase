...
namespace NETDeveloperCaseStudy.Core.DataAccess.EntityFramework;
...
{
    protected readonly IdentityDbContext<ExtendedIdentityUser, IdentityRole, string> _context;
    protected readonly DbSet<TEntity> _table;

    protected EFBaseRepository(IdentityDbContext<ExtendedIdentityUser, IdentityRole, string> context)
    {
        _context = context;
